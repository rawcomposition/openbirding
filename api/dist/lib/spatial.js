...
export function kCenterClustering(points, k, startLat, startLng) {
...
export function desiredClusters(hotspotCount, minK = 3, maxK = 30, scale = 1.5) {
    if (hotspotCount <= 0)
        return minK;
